...
<script type="text/javascript" src="<?php base_url() ?>assets/js/chart.min.js"></script>
<script type="text/javascript" src="<?php base_url() ?>assets/js/chart.custome.js"></script>
